...
SECRET_KEY = 'django-insecure-9ip)fipsp%2v!tfhcuvqgl323x&w$^k^372x23_=u2%&^vo9*+'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'promptProject', 'static')
...
SESSION_COOKIE_AGE = 2592000  # One month, in seconds
